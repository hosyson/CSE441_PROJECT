...
import Model.WeatherData24h.WeatherData24h;
...
public class CustomAdapter24h extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        String imageUrl = "https://developer.accuweather.com/sites/default/files/" + String.format("%02d", Integer.parseInt(weather.Image)) + "-s.png";
        Picasso.get().load(imageUrl).into(imgStatus);
